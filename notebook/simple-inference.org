...
;; y = 0.5 * x + e
;; e ~ N(μ=0, σ=0.1)
(defparameter *observations* (loop with n = 100
...
(defparameter *posterior* (nth-value 1 (permo:line *observations* :n-particles 100 :steps 100)))
...
#+RESULTS:
: #<HASH-TABLE :TEST EQUAL :COUNT 1 {100AD13183}>
